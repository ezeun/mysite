...
select * from board;
select * from user;
insert into board values(null, "모먹지?", "글 내용1",5, "2024-07-15",1,1,0,9);
insert into board values(null, "ㅎㅇ!", "글 내용2",30, "2024-07-14",2,1,0,9);
insert into board values(null, "짬뽕", "글 내용3",23, "2024-07-16",1,4,1,10);
